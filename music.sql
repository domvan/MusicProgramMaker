...
ALTER TABLE `trio`
    ADD CONSTRAINT `trio_ibfk_1` FOREIGN KEY (`gID`) REFERENCES `group` (`gID`),
...
ALTER TABLE `group_can_edit`
    ...
    ADD CONSTRAINT `group_can_edit_ibfk_2` FOREIGN KEY (`gID`) REFERENCES `group` (`gID`);
...
ALTER TABLE `group_performs`
    ADD CONSTRAINT `group_performs_ibfk_1` FOREIGN KEY (`gID`) REFERENCES `group` (`gID`),
