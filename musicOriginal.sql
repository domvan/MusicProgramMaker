...
INSERT INTO `group` (`gID`, `age`, `bio`) VALUES
...
INSERT INTO `group_performs` (`gID`, `pID`) VALUES
('1', '2'),
('2', '2');
COMMIT;
...
ALTER TABLE `trio`
    ADD CONSTRAINT `trio_ibfk_1` FOREIGN KEY (`gID`) REFERENCES `group` (`gID`) ON DELETE CASCADE,
...
ALTER TABLE `group_can_edit`
    ...
    ADD CONSTRAINT `group_can_edit_ibfk_2` FOREIGN KEY (`gID`) REFERENCES `group` (`gID`) ON DELETE CASCADE;
...
ALTER TABLE `composer_can_edit`
    ADD CONSTRAINT `composer_can_edit_ibfk_1` FOREIGN KEY (`adminUsername`) REFERENCES `admin` (`username`) ON DELETE CASCADE,
    ADD CONSTRAINT `composer_can_edit_ibfk_2` FOREIGN KEY (`cName`) REFERENCES `composer` (`cName`) ON DELETE CASCADE;
...
ALTER TABLE `group_performs`
    ADD CONSTRAINT `group_performs_ibfk_1` FOREIGN KEY (`gID`) REFERENCES `group` (`gID`) ON DELETE CASCADE,
    ADD CONSTRAINT `group_performs_ibfk_2` FOREIGN KEY (`pID`) REFERENCES `program` (`pID`) ON DELETE CASCADE;

ALTER TABLE `solo_performs`
    ADD CONSTRAINT `solo_performs_ibfk_1` FOREIGN KEY (`name`) REFERENCES `performer` (`name`) ON DELETE CASCADE,
    ADD CONSTRAINT `solo_performs_ibfk_2` FOREIGN KEY (`pID`) REFERENCES `program` (`pID`) ON DELETE CASCADE;
